      ...
      {isOpen && (
        ...
        >
          <div className="date-picker-header">
            <button className="month-nav-button" onClick={handlePrevMonth} aria-label="Previous month">
              <ChevronLeft size={20} />
            </button>
            <h2>{format(currentMonth, "MMMM yyyy")}</h2>
            <button className="month-nav-button" onClick={handleNextMonth} aria-label="Next month">
